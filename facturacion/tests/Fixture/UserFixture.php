...
class UserFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_user_rol1_idx' => ['type' => 'index', 'columns' => ['rol_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'email_UNIQUE' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
            'fk_user_rol1' => ['type' => 'foreign', 'columns' => ['rol_id'], 'references' => ['rol', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'rol_id' => 1,
                'status' => 1,
                'created' => '2019-05-29 22:23:24',
                'modified' => '2019-05-29 22:23:24'
            ],
        ];
        parent::init();
    }
