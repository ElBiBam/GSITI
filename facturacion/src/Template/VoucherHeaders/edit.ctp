...
<div  style="background: #0D1D52;">
            <ul class="nav nav-tabs">
                   <li><?= $this->Form->postLink(
                            ...
                            ['confirm' => __('Are you sure you want to delete # {0}?', $voucherHeader->id), 'class' => 'btn btn-danger', ['class' => 'nav-link']]
                        )
                    ?></li>
                    <li><?= $this->Html->link(__('List Voucher Headers'), ['action' => 'index'], ['class' => 'nav-link']) ?></li>
                    <li><?= $this->Html->link(__('List Voucher Types'), ['controller' => 'VoucherTypes', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
                    <li><?= $this->Html->link(__('New Voucher Type'), ['controller' => 'VoucherTypes', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
                    <li><?= $this->Html->link(__('List Sellers'), ['controller' => 'Sellers', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
                    <li><?= $this->Html->link(__('New Seller'), ['controller' => 'Sellers', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
                    <li><?= $this->Html->link(__('List Clients'), ['controller' => 'Clients', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
                    <li><?= $this->Html->link(__('New Client'), ['controller' => 'Clients', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
                </ul>
    </div>
...
<fieldset> 
    <div class="row">	
	    ...
	    <div class="col-sm-2">
                <?php echo $this->Form->input($i.'.amount', ['type'=>'number', 'label' => '', 'step'=>'0.01']); ?>            
            </div>                                   
    </div>
<?php
    }
