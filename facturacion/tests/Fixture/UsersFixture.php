...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_user_role1' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['roles', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'status' => 1,
                'created' => '2019-06-11 12:45:43',
                'modified' => '2019-06-11 12:45:43'
            ],
        ];
        parent::init();
    }
