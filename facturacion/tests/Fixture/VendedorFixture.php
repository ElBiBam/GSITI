...
class VendedorFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_vendedor_persona1_idx' => ['type' => 'index', 'columns' => ['persona_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'persona_id_UNIQUE' => ['type' => 'unique', 'columns' => ['persona_id'], 'length' => []],
            'fk_vendedor_persona1' => ['type' => 'foreign', 'columns' => ['persona_id'], 'references' => ['persona', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
